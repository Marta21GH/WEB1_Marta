  ...
  return (
    <div style={styles.container}>
      <header style={styles.header}>
        ...
        <nav>
          <Link href="/clients" style={styles.link}>
          Listado de Clientes
          </Link>
          <Link href="/providers" style={styles.link}>
        ...
        <div style={styles.formBox}>
          ...
          <form onSubmit={handleCreateClient} style={styles.form}>
            ...
            <input
              ...
              name="address.number"
              placeholder="Número"
              value={formDataClient.address.number}
              onChange={handleInputChangeClient}
            />
            <input
              type="text"
              ...
              value={formDataClient.address.postal}
              onChange={handleInputChangeClient}
            />
            <input
              type="text"
              name="address.city"
              placeholder="Ciudad"
              value={formDataClient.address.city}
              onChange={handleInputChangeClient}
            />
            <input
              type="text"
              ...
              value={formDataClient.address.province}
              onChange={handleInputChangeClient}
            />
        ...
        <div style={styles.formBox}>
          ...
          <form onSubmit={handleCreateProvider} style={styles.form}>
            ...
            <input
              ...
              name="address.number"
              placeholder="Número"
              value={formDataProvider.address.number}
              onChange={handleInputChangeProvider}
            />
            <input
              type="text"
              name="address.postal"
              placeholder="Código Postal"
              value={formDataProvider.address.postal}
              onChange={handleInputChangeProvider}
            />
            <input
              type="text"
              name="address.city"
              placeholder="Ciudad"
              value={formDataProvider.address.city}
              onChange={handleInputChangeProvider}
            />
            <input
              type="text"
              name="address.province"
              placeholder="Provincia"
              value={formDataProvider.address.province}
              onChange={handleInputChangeProvider}
            />
